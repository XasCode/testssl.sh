...
FILES=$(/home/testssl/google-cloud-sdk/bin/gsutil ls gs://${PROJECT}-results/queue/*)

for i in $FILES; do 
  /home/testssl/google-cloud-sdk/bin/gsutil rm $i
done
...
for j in $FILES; do 
  ...
  /home/testssl/google-cloud-sdk/bin/gsutil cp /home/testssl/out.json gs://${PROJECT}-results/$(basename $j)
done